...
1:Create Folder Structure 
 1. create root folder as jscasri
 2. add frontend and backend folder
 3. create src folder in frontend
 4. create index html with heading jscasri in src
 5. run npm init in frontend folder
 6. npm install live-server
 7. addd start command as live-server src --verbose 
 8. run npm start

 2: Design Website
  1. create style.css
  2. link style,css index.html
  ...
  3: Create Static Home Screen
   ...
   4. add .product-img, .product-name, . product-brand,  .priduct-price
   5. style ul.products and internal divs
   6. duplicate  2 times to show 3 products

   4: Render Dynamic Home Screen
    1. create data.js
    2. export an array o f6 products
    3. create screen/HomeScreen.js
    4. export HomeScreen as an Object with render() method
    5. implement render()
    6. import data.js
    9. link it to index.html as module
    10. set main id to main _conainer 
    11. create router() function
    12. set main_container innerHtml to HomeScreen.render()
    13. set load event of window to router() function

    5: Build Dynamic Home Screen
    1. create routes as route:screen object for home screen 
    2. create utils.js
    3. export parseRequenst URL()
    4. set url as hash address spit by slash
    5. reutrn resource, id and verb of url
    6. update router()
    ...
    6: Create Node.js Server 
     1. run mp init in root jsamazona folder
     2. npm istall express
     3. create server.js
     4. add start command as node ackend/server.js
     5. require exrpress
     ...
     2. make render async
     3. fetch product from '/api/product' in render()
     ...
     5. move index.html, style.css and image to frontend folder
     ...
     9: install babel for ES6 Syntax 
      ...
      2. create .abelrc and set presets to @babel/preset-env
